...
function LeftSmallDescription({ rowClassName, DescBoxClass, BoxTittle, BoxDescription, RouterLink, BtnTittle }) {
  return (
    <div className={`row p-0 ${rowClassName}`}>
        ...
        <div className='col-lg-7 col-md-0 col-sm-0 p-0 m-0'></div>
    </div>
  )
}
